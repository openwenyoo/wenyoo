(function () {
    ...
    const messages = {
        en: {
            ...
            'user.logout': 'Log out',
            'user.logoutConfirm': 'Log out? Your name will be cleared and you will return to the name input screen.',
        ...
        'zh-CN': {
            ...
            'settings.export': '导出',
            'settings.playerName': '玩家',
            'settings.return': '返回菜单',
            'settings.reload': '重新加载游戏',
            'user.logout': '退出登录',
            'user.logoutConfirm': '确定退出登录？你的名称将被清除，并返回到名称输入页面。',
