...
### Built-in Text Client Only

Wenyoo now targets the built-in text/world-simulator client only. Do not add `frontend.app`, packaged HTML/JS bundles, or bridge-specific story runtime code when creating a story for this repo.
